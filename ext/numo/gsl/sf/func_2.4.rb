[{:func_name=>"gsl_sf_Chi",
 ...
 {:func_name=>"gsl_sf_hermite_func",
  ...
  :desc=>
   "These routines evaluate the Hermite function \\psi_n(x) of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_func_array",
  ...
  :args=>
   [["const int", "nmax"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all Hermite functions \\psi_n(x) up to order nmax at position x.\r\n" +
 ...
 {:func_name=>"gsl_sf_hermite_func_zero_e",
  ...
  :desc=>
   "These routines evaluate the s-th zero of the Hermite function \\psi_n(x) of order n.\r"},
 {:func_name=>"gsl_sf_hermite_phys",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the physicists' Hermite polynomial H_n(x) of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_phys_array",
  :func_type=>"int",
  :args=>
   [["const int", "nmax"],
    ["const double", "x"],
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all physicists' Hermite polynomials H_n up to order nmax at position x.\r\n" +
   "The results are stored in result_array.\r"},
 {:func_name=>"gsl_sf_hermite_phys_array_der",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "nmax"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates the m-th derivative of all physicists' Hermite polynomials H_n up to order nmax at position x.\r\n" +
   "The results are stored in result_array.\r"},
 {:func_name=>"gsl_sf_hermite_phys_der",
  :func_type=>"double",
  :args=>[["const int", "m"], ["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the m-th derivative of the physicists' Hermite polynomial H_n(x) of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_phys_der_array",
  :func_type=>"int",
  :args=>
   [["const int", "mmax"],
    ["const int", "n"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all derivatives (starting from 0) up to the mmax-th derivative of the\r\n" +
   "physicists' Hermite polynomial of order n H_n at position x. The results are stored in result_array.\r"},
 {:func_name=>"gsl_sf_hermite_phys_der_e",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "n"],
  ...
  :desc=>
   "These routines evaluate the m-th derivative of the physicists' Hermite polynomial H_n(x) of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_phys_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const double", "x"], ["gsl_sf_result *", "result"]],
  :desc=>
   "These routines evaluate the physicists' Hermite polynomial H_n(x) of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_phys_series",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const double", "x"], ["const double *", "a"]],
  :desc=>
   "These routines evaluate the series \\sum_{j=0}^n a_j H_j(x) with H_j being\r\n" +
   "the j-th physicists' Hermite polynomial using the Clenshaw algorithm.\r"},
 {:func_name=>"gsl_sf_hermite_phys_series_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"],
    ["const double", "x"],
  ...
  :desc=>
   "These routines evaluate the series \\sum_{j=0}^n a_j H_j(x) with H_j being\r\n" +
   "the j-th physicists' Hermite polynomial using the Clenshaw algorithm.\r"},
 {:func_name=>"gsl_sf_hermite_phys_zero",
  :func_type=>"double",
  :args=>[["const int", "n"], ["const int", "s"]],
  :desc=>
   "These routines evaluate the s-th zero of the physicists' Hermite polynomial H_n(x) of order n.\r"},
 {:func_name=>"gsl_sf_hermite_phys_zero_e",
  :func_type=>"int",
  :args=>
   [["const int", "n"], ["const int", "s"], ["gsl_sf_result *", "result"]],
  :desc=>
 ...
 {:func_name=>"gsl_sf_hermite_prob",
  ...
  :args=>[["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the probabilists' Hermite polynomial He_n(x) of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_prob_array",
  ...
  :args=>
   [["const int", "nmax"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all probabilists' Hermite polynomials He_n(x) up to order nmax at position x.\r\n" +
   "The results are stored in result_array.\r"},
 {:func_name=>"gsl_sf_hermite_prob_array_der",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "nmax"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates the m-th derivative of all probabilists' Hermite polynomials He_n(x) up to\r\n" +
   "order nmax at position x. The results are stored in result_array.\r"},
 {:func_name=>"gsl_sf_hermite_prob_der",
  :func_type=>"double",
  :args=>[["const int", "m"], ["const int", "n"], ["const double", "x"]],
  :desc=>
   "These routines evaluate the m-th derivative of the probabilists' Hermite polynomial He_n(x)\r\n" +
   "of order n at position x.\r"},
 {:func_name=>"gsl_sf_hermite_prob_der_array",
  :func_type=>"int",
  :args=>
   [["const int", "mmax"],
    ["const int", "n"],
    ...
    ["double *", "result_array"]],
  :desc=>
   "This routine evaluates all derivatives (starting from 0) up to the mmax-th derivative of the probabilists' Hermite\r\n" +
   "polynomial of order n He_n(x) at position x. The results are stored in result_array.\r"},
 {:func_name=>"gsl_sf_hermite_prob_der_e",
  :func_type=>"int",
  :args=>
   [["const int", "m"],
    ["const int", "n"],
 ...
 {:func_name=>"gsl_sf_hermite_prob_series",
  ...
  :desc=>
   ...
   "j-th probabilists' Hermite polynomial using the Clenshaw algorithm.\r"},
 ...
 {:func_name=>"gsl_sf_hermite_prob_zero",
  ...
  :args=>[["const int", "n"], ["const int", "s"]],
  :desc=>
   "These routines evaluate the s-th zero of the probabilists' Hermite polynomial He_n(x) of order n.\r"},
 ...
 {:func_name=>"gsl_sf_hyperg_0F1",
  ...
  :desc=>"These routines compute the hypergeometric function {}_0F_1(c,x)."},
